package com.hf.oauth.controller;


import com.hf.Result;
import com.hf.oauth.service.LoginService;
import com.hf.oauth.util.AuthToken;
import com.hf.oauth.util.CookieUtil;
...
public class UserLoginController {
    ...
    public Result<Map> login(String username, String password) {
        ...
        return new Result<Map>(true,"令牌生成成功",authToken);
    }
